...
:: Copy Library
copy "Installer\Library\*" "%target_directory%\bin\" >nul

:: Copy Configuration
copy "Installer\Configs\*.ini" "%target_directory%\bin\" >nul
copy "Installer\Configs\*.ini" "%target_directory%\bin\config-include\" >nul

::RegionConfig.ini.example
copy "Installer\Configs\RegionConfig.ini.example" "%target_directory%\bin\Regions\" >nul
::MyWorld.ini.example
copy "Installer\Configs\MyWorld.ini.example" "%target_directory%\bin\config-include\" >nul
::OpenSim.ini
copy "Installer\Configs\OpenSim.ini" "%target_directory%\bin\" >nul
